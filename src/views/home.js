        ...
        <>
            ...
            <form action="" class="form_main">
                ...
                <div class="inputContainer">
                    ...
                    <input type="text" class="inputField" id="username" placeholder="Username" onChange={(e) => {
                ...
                <div class="inputContainer">
                    ...
                    <input type="password" class="inputField" id="password" placeholder="Password" onChange={(e) => {
